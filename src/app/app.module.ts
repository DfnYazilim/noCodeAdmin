...
const appRoutes: Routes = [
    ...
    {path: 'login', loadChildren: () => import('./kapo/login/login.module').then(m => m.LoginModule)},
    {path: 'kapo', loadChildren: () => import('./kapo/kapo.module').then(m => m.KapoModule), canActivate : [AuthGuard]},
    {
        path: '**',
