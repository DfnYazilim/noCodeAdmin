...
// Set the private defaults
        ...
        // this._coreTranslationService.translate(menuEnglish, menuTurkish);
        ...
        this.setLanguage(conf?.app?.appLanguage || "tr")


    }

    setLanguage(language): void {
        console.log("gelen dil : " + language)
        const lngs = this._translateService.getLangs()
        const otherLngs = lngs.filter(a=>a !== language)
        otherLngs.forEach(f=>{
            this._translateService.use(f)
        })
